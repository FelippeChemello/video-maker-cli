    ...
    if (content.videoDestination == 'YouTube') {
        ...
        async function authenticateWithOAuth() {
            ...
            async function createOAuthClient() {
                ...
                const OAuthClient = new OAuth2(credentials.web.client_id, credentials.web.client_secret, credentials.web.redirect_uris[0])
        ...
        async function uploadVideo(content) {
            try {
                ...
                function onUploadProgress(event) {
                    ...
                    console.log(
                        `> [youtube-robot] ${progress}% completed - ${(event.bytesRead / 1000000).toFixed(2)}MB of ${(
